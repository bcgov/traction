...
@router.post(
    "/tenants/{tenant_id}/students/{student_id}/issue-degree",
    status_code=status.HTTP_200_OK,
)
async def get_student(
    ...
    traction.tenant_issue_credential(
        tenant.wallet_id, tenant.wallet_key, student.connection.connection_id, ""
    )

    ["student_id", "name", "date", "degree", "age"]
    return item
