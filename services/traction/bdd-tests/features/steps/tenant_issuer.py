...
#     json = {
#         "cred_protocol": "v1.0",
#         "credential": {"attributes": [{"name": "string", "title": "string"}]},
#         "cred_def_id": [
#             schema
#             for schema in context.config.userdata["governance"]["schemas"]
#             if schema["schema_name"] == schema_name
#         ]["cred_def_id"],
#         "contact_id": context.config.userdata[issuer]["connections"][holder][
#             "contact_id"
#         ],
#     }
