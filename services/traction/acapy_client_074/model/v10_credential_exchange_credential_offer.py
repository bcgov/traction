...
def lazy_import():
    from acapy_client_074.model.indy_cred_abstract import IndyCredAbstract
    from acapy_client_074.model.indy_cred_abstract_key_correctness_proof import (
...
class V10CredentialExchangeCredentialOffer(ModelComposed):
