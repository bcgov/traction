...
from acapy_client_074 import rest
from acapy_client_074.configuration import Configuration
from acapy_client_074.exceptions import ApiTypeError, ApiValueError, ApiException
from acapy_client_074.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def request(
        ...
        logger.debug(f"Adding headers to API call: {headers}")
