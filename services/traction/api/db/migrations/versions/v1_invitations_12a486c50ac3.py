...
def upgrade():
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint("connection_invitation_id"),
    )
    op.create_index(
        op.f("ix_connection_invitation_name"),
        "connection_invitation",
        ["name"],
        unique=False,
    )
    op.create_index(
        op.f("ix_connection_invitation_invitation_key"),
        "connection_invitation",
        ["invitation_key"],
        unique=False,
    )
    op.create_index(
        op.f("ix_connection_invitation_tenant_id"),
        "connection_invitation",
        ["tenant_id"],
        unique=False,
    )
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(
        op.f("ix_connection_invitation_tenant_id"), table_name="connection_invitation"
    )
    op.drop_index(
        op.f("ix_connection_invitation_name"), table_name="connection_invitation"
    )
    op.drop_table("connection_invitation")
    # ### end Alembic commands ###
