...
from acapy_wrapper_074.models.connection_list import ConnectionList
from acapy_wrapper_074.models.connection_metadata import ConnectionMetadata
from acapy_wrapper_074.models.connection_metadata_set_request import (
    ConnectionMetadataSetRequest,
)
from acapy_wrapper_074.models.connection_static_request import ConnectionStaticRequest
from acapy_wrapper_074.models.connection_static_result import ConnectionStaticResult
from acapy_wrapper_074.models.create_invitation_request import CreateInvitationRequest
from acapy_wrapper_074.models.endpoints_result import EndpointsResult
from acapy_wrapper_074.models.invitation_result import InvitationResult
from acapy_wrapper_074.models.receive_invitation_request import ReceiveInvitationRequest
...
async def connections_conn_id_accept_invitation_post(
    ...
    mediation_id: str = Query(
        None, description="Identifier for active mediation record to be used"
    ),
...
async def connections_get(
    ...
    invitation_msg_id: str = Query(
        None, description="Identifier of the associated Invitation Mesage"
    ),
    my_did: str = Query(
        None,
        description="My DID",
