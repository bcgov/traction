...
from acapy_wrapper_074.models.linked_data_proof import LinkedDataProof
...
class CredentialProof(BaseModel):
    ...
    CredentialProof - a model defined in OpenAPI

        challenge: The challenge of this CredentialProof [Optional].
        created: The created of this CredentialProof.
        domain: The domain of this CredentialProof [Optional].
        jws: The jws of this CredentialProof [Optional].
        nonce: The nonce of this CredentialProof [Optional].
        proof_purpose: The proof_purpose of this CredentialProof.
        proof_value: The proof_value of this CredentialProof [Optional].
        type: The type of this CredentialProof.
        verification_method: The verification_method of this CredentialProof.
    """
...
CredentialProof.update_forward_refs()
