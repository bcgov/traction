...
class V20PresentationSendRequestToProposal(BaseModel):
    ...
    V20PresentationSendRequestToProposal - a model defined in OpenAPI
        ...
        auto_verify: The auto_verify of this V20PresentationSendRequestToProposal [Optional].
        trace: The trace of this V20PresentationSendRequestToProposal [Optional].
    """
