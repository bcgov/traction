...
from acapy_wrapper_074.models.v10_presentation_exchange_presentation import (
    V10PresentationExchangePresentation,
)
from acapy_wrapper_074.models.v10_presentation_exchange_presentation_proposal_dict import (
    V10PresentationExchangePresentationProposalDict,
)
from acapy_wrapper_074.models.v10_presentation_exchange_presentation_request import (
    V10PresentationExchangePresentationRequest,
)
from acapy_wrapper_074.models.v10_presentation_exchange_presentation_request_dict import (
...
class V10PresentationExchange(BaseModel):
    ...
    presentation: Optional[V10PresentationExchangePresentation] = Field(
        alias="presentation", default=None
    )
    presentation_exchange_id: Optional[str] = Field(
        alias="presentation_exchange_id", default=None
    )
    presentation_proposal_dict: Optional[
        V10PresentationExchangePresentationProposalDict
    ] = Field(alias="presentation_proposal_dict", default=None)
    presentation_request: Optional[V10PresentationExchangePresentationRequest] = Field(
        alias="presentation_request", default=None
    )
    presentation_request_dict: Optional[
        V10PresentationExchangePresentationRequestDict
    ] = Field(alias="presentation_request_dict", default=None)
