...
class V20CredExRecordIndy(BaseModel):
    ...
    cred_ex_indy_id: Optional[str] = Field(alias="cred_ex_indy_id", default=None)
    cred_id_stored: Optional[str] = Field(alias="cred_id_stored", default=None)
    cred_request_metadata: Optional[Dict[str, Any]] = Field(
        alias="cred_request_metadata", default=None
    )
