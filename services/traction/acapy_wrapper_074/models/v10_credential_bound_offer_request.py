...
from acapy_wrapper_074.models.v10_credential_bound_offer_request_counter_proposal import (
...
class V10CredentialBoundOfferRequest(BaseModel):
    ...
    counter_proposal: Optional[V10CredentialBoundOfferRequestCounterProposal] = Field(
        alias="counter_proposal", default=None
    )
