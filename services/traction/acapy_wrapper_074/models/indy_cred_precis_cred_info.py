...
class IndyCredPrecisCredInfo(BaseModel):
    """NOTE: This class is auto generated by OpenAPI Generator (https://openapi-generator.tech).

    Do not edit the class manually.

    IndyCredPrecisCredInfo - a model defined in OpenAPI

        attrs: The attrs of this IndyCredPrecisCredInfo [Optional].
        cred_def_id: The cred_def_id of this IndyCredPrecisCredInfo [Optional].
        cred_rev_id: The cred_rev_id of this IndyCredPrecisCredInfo [Optional].
        referent: The referent of this IndyCredPrecisCredInfo [Optional].
        rev_reg_id: The rev_reg_id of this IndyCredPrecisCredInfo [Optional].
        schema_id: The schema_id of this IndyCredPrecisCredInfo [Optional].
    """
...
IndyCredPrecisCredInfo.update_forward_refs()
