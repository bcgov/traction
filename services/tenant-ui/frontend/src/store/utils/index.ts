...
export function filterByStatusActive(item: any){ return item.status === 'Active'; }
export function sortByLabelAscending(a:any, b: any) { return a.label.localeCompare(b.label); }