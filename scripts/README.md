...
This image is based on [ghcr.io/openwallet-foundation/acapy-agent:py3.13-1.6.1](https://github.com/openwallet-foundation/acapy/releases/tag/1.6.1) and this is where we pull in the [traction plugins](../plugins) and build out the image see [Dockerfile](../plugins/docker/Dockerfile)
