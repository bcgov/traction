...
This image is based on [bcgovimages/aries-cloudagent:py36-1.16-1_0.8.2](https://hub.docker.com/layers/bcgovimages/aries-cloudagent/py36-1.16-1_0.8.2/images/sha256-fad76f90effb37141389cadb1ee70821d2d700e917e76427ecc0c8077c5b2f8d?context=explore) and this is where we pull in the [traction plugins](../plugins) and build out the image see [Dockerfile](../plugins/docker/Dockerfile)
