...
This image is based on [bcgovimages/aries-cloudagent:py36-1.16-1_0.8.1](https://hub.docker.com/layers/bcgovimages/aries-cloudagent/py36-1.16-1_0.8.1/images/sha256-0c2f34a84b672ee68439b5dab7db9298b7945d2f2b54c165ec346a8096b7ff31?context=explore) and this is where we pull in the [traction plugins](../plugins) and build out the image see [Dockerfile](../plugins/docker/Dockerfile)
